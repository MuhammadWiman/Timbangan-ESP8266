...
const char* CL = "LSKK-Gas-d43289755a12"; //ini diganti
String deviceGuid = "Timbangan-Gas-d43289755a12"; //ini diganti juga
byte mac[6];
int address = 0; 
int waktuKirim = 1000;
String MACAddress;
...
//  Serial.println(pzem.readAddress(), HEX);
  ...
  float containerWeight = 5.20; // tergantung nilai data dari script kalibrasi
