...
const char* CL = "LSKK-DISPENSER-LLVwJMGJWNNbs"; //ini diganti
String deviceGuid = "Timbangan-2022-001-001-LLVwJMGJWNNbs"; //ini diganti juga
byte mac[6];
int address = 0; 
int waktuKirim = 20000;
String MACAddress;
float Weight;
...
//  Serial.println(dataSendtoMqtt); 
  ...
  float containerWeight = 8.24; // tergantung nilai data dari script kalibrasi
