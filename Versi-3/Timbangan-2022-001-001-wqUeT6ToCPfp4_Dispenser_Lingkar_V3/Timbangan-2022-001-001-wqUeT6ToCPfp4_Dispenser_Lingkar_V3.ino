...
const char* CL = "LSKK-DISPENSER-wqUeT6ToCPfp4"; //ini diganti
String deviceGuid = "Timbangan-2022-001-001-wqUeT6ToCPfp4"; //ini diganti juga
byte mac[6];
int address = 0; 
int waktuKirim = 1000;
String MACAddress;
...
//  Serial.println(dataSendtoMqtt);  //30000
  ...
  float containerWeight = 18.21; // tergantung nilai data dari script kalibrasi
  // jika nilai Weight ++ = Weight - containerWeight
  //jika nilai Weight -- = containerWeight - Weight
