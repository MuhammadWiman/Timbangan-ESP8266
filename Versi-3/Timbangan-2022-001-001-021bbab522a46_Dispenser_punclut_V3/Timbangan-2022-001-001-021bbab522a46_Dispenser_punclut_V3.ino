...
const char* CL = "LSKK-DISPENSER-021bbab522a46"; //ini diganti
String deviceGuid = "Timbangan-2022-001-001-021bbab522a46"; //ini diganti juga
byte mac[6];
int address = 0; 
int waktuKirim = 1000;
String MACAddress;
...
//  Serial.println(dataSendtoMqtt);  //30000
  ...
  float containerWeight = 4.35; // tergantung nilai data dari script kalibrasi
